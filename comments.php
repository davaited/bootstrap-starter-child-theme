...
<div id="comments" class="comments-area">
    ...
    <?php comment_form( $args = array(
        ...
        'title_reply'       => __( 'Оставьте свой отзыв', 'wp-bootstrap-starter' ),  // that's the wordpress default value! delete it or edit it ;)
        ...
        'label_submit'      => __( 'Отправить отзыв', 'wp-bootstrap-starter' ),  // that's the wordpress default value! delete it or edit it ;)

        'comment_field' =>  '<p><textarea placeholder="Ваш отзыв..." id="comment" class="form-control" name="comment" cols="45" rows="8" aria-required="true"></textarea></p>',
